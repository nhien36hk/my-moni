    ...
    <div className="min-h-[90vh] flex flex-col justify-center px-4 py-12">
      <div className="w-full max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 space-y-6">
          ...
          >
            {isLoading ? 'Đang xử lý...' : 'Đăng ký'} <ChevronRight size={18} />
          </button>

          <p className="text-center text-xs text-[var(--text-secondary)]">
            Đã có tài khoản? <Link to="/login" className="text-[var(--accent-primary)] font-bold cursor-pointer hover:underline">Đăng nhập ngay</Link>
          </p>
        </form>
      </div>
    </div>
